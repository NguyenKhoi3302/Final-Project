    ...
    public function run()
    {
        ...
        for ($i = 0; $i<100; $i++){
            ...
            DB::table('products')->insert([
                ...
                'product_category' => Arr::random($cat),
                ...
                'content' => '• Thiết kế thanh lịch, sang trọng pha một chút cá tính của mẫu Đồng hồ EDIFICE 47.1 mm Nam EFR-573HG-1AVUDF này đến từ hãng đồng hồ Casio thuộc dòng Edifice Casio, một trong những thương hiệu nổi tiếng toàn cầu.
