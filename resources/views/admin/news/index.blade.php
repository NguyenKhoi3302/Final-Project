            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" id="search" class="form-control" placeholder="Nhập tiêu đề bài viế">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
...
<div class="row mt-3">
    <div class="Page navigation m-auto">
        ...
        <ul class="pagination">
            ...
            @for($i = 1; $i <= $pages; $i++) <li class="@if($news_list->currentPage() == $i)current @endif page-item">
