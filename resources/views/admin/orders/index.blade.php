                    ...
                    <tr style="text-align: center">
                        ...
                        <td>
                            <select data-id="{{$item->id}}" onchange="update_status({{$item->id}})" id="status"
                                ...
                                <option <?php if($item->status == "Đang Chờ Duyệt" ) { echo "selected"; } ?>value="Đang
                                    Chờ Duyệt">Đang Chờ Duyệt</option>
                                <option <?php if($item->status == "Đang giao hàng" ) { echo "selected"; } ?> value="Đang
                                    giao hàng">Đang Giao Hàng</option>
                                <option <?php if($item->status == "Giao thành công" ) { echo "selected"; } ?>
                                    value="Giao thành công">Giao Thành Công</option>
                            </select>
                        </td>
                        <td>{{$item->status}}</td>
                        <td>{{$item->note}}</td>
