            ...
            <div class="swiper-slide">
                <div class="banner_item" style="background-image: url('{{asset('images/banner/home_banner_2.jpg')}}')">
                    {{-- <div class="home_banner_content">--}}
                        ...
                        {{-- <div class="banner_description">Đơn giản, dễ dùng, tiết kiệm thời gian. Dễ dàng thống kê
                            quản lý mặt hàng trang phục</div>--}}
        ...
        <div class="list_item">
            <div class="item" data-aos="fade-up" data-aos-duration="500" data-aos-delay="300">
                <div class="item_cont">
                    ...
                    <div class="item_des">Giao diện đơn giản, thân thiện và thông minh. Nhân viên chỉ mất 15 phút làm
                        quen để bán hàng.</div>
                </div>
                <div class="item_img">
    ...
    <div class="grid-container">
        <div class="grid-50" data-aos="fade-right" data-aos-duration="500" data-aos-delay="300">
            <div class="content_wrap">
                ...
                <div class="sec_cont">
                    <p>Chúng tôi là công ty công nghệ cung cấp những giải pháp đơn giản với chi phí tiết kiệm, giúp
                        khách hàng nâng cao hiệu quả kinh doanh.</p>
                    <p>Chúng tôi hướng tới tầm nhìn trở thành công ty cung cấp giải pháp công nghệ cho doanh nghiệp phổ
                        biến tại Đông Nam Á.</p>
                </div>
    ...
    <div class="grid-container">
        ...
        <div class="home_news_wrap">
            ...
            <div class="item">
                ...
                <div class="item_cont">
                    <div class="title">
                        <h3><a href="{{route('single-news',[$news->id])}}">{{$news->title}}</a></h3>
                    </div>
                    <div class="date">
                        <span>
