            ...
            <div class="footer_main">
                ...
                <div class="footer_bottom">
                    ...
                    <div class="item">
                        ...
                        <ul>
                            <li><a href="" contenteditable="true">Danh mục 1</a></li>
                        ...
                        <div class="social">
                            <a href="">
                                <svg width="43" height="42" viewBox="0 0 43 42" fill="none"
                                    ...
                                    <path
                                        d="M26.7607 22.3672L27.3734 18.5651H23.5993V16.0937C23.5993 15.054 24.1262 14.0381 25.8111 14.0381H27.551V10.8004C26.5378 10.6426 25.5139 10.5572 24.4877 10.5449C21.3815 10.5449 19.3536 12.3688 19.3536 15.6659V18.5651H15.9104V22.3672H19.3536V31.5636H23.5993V22.3672H26.7607Z"
                                        fill="white" />
                                </svg>
                            </a>
                        </div>
                        <div class="social">
                            <a href="">
                                <svg width="43" height="42" viewBox="0 0 43 42" fill="none"
                                    ...
                                    <path
                                        d="M33.4597 15.2232C33.1789 14.1923 32.3484 13.379 31.2917 13.1003C29.3812 12.6001 21.7155 12.6001 21.7155 12.6001C21.7155 12.6001 14.0536 12.6001 12.1392 13.1003C11.0864 13.3752 10.2559 14.1885 9.97124 15.2232C9.46045 17.0941 9.46045 21.0001 9.46045 21.0001C9.46045 21.0001 9.46045 24.9061 9.97124 26.777C10.252 27.8079 11.0825 28.6212 12.1392 28.8999C14.0536 29.4001 21.7155 29.4001 21.7155 29.4001C21.7155 29.4001 29.3812 29.4001 31.2917 28.8999C32.3445 28.625 33.175 27.8117 33.4597 26.777C33.9705 24.9061 33.9704 21.0001 33.9704 21.0001C33.9704 21.0001 33.9705 17.0941 33.4597 15.2232Z"
                                        fill="white" />
                                    <path d="M19.2668 24.6006L25.6341 21.0001L19.2668 17.3995V24.6006Z"
                                        fill="#FF0000" />
                                </svg>
                            </a>
                        </div>
